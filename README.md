...
```powershell
iwr "https://raw.githubusercontent.com/mhmtsk44/Office_ISO_Araci/refs/heads/main/Office_ISO_Araci_v5_0_DPI_Aware.ps1" -OutFile "$env:TEMP\Office_ISO.ps1"; powershell -ExecutionPolicy Bypass -File "$env:TEMP\Office_ISO.ps1"
```
